...
const SYNONYMS: Record<string, string[]> = {
  ...
  direct_number: ['direct_number', 'direct', 'direct_line', 'direct_dial', 'ddi', 'phone_3'],
  phone_number: ['phone_number', 'phone', 'telephone', 'landline', 'office_number', 'office_phone', 'contact_no', 'contact_number', 'tel', 'phone_4'],
